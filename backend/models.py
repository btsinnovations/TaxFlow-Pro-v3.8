...
class Vendor(Base):
    """B3.04 â€” Vendor record for bills, payments, and 1099 tracking."""
...
class SalesTaxRate(Base):
    """B3.04 â€” Sales tax rate by jurisdiction and effective date."""
...
class SalesTaxPayment(Base):
    """B3.04 â€” Remitted sales tax payment."""
...
class MileageLog(Base):
    """B3.04 â€” Vehicle mileage log for tax deduction."""
