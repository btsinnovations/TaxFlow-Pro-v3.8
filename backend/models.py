...
class FirmSettings(Base):
    ...
    recurring_high_confidence = Column(Numeric(5, 4), default=0.95)
    recurring_medium_confidence = Column(Numeric(5, 4), default=0.75)
    recurring_auto_confirm = Column(Numeric(5, 4), default=0.90)
    receipt_match_amount_weight = Column(Numeric(3, 2), default=0.40)
    receipt_match_date_weight = Column(Numeric(3, 2), default=0.35)
