"""Wells Fargo checking, savings, and credit card statement parser."""
...
def _parse_lines(text: str) -> List[Dict[str, Any]]:
    """Wells Fargo: MM/DD Description Debit Credit [Balance]."""
...
class WellsFargoParser:
    ...
    def can_handle(cls, text: str) -> bool:
        return "wells fargo" in text.lower()
...
def parse_wells_fargo_pdf(pdf_path: str, raw_text: str) -> Dict[str, Any]:
    return WellsFargoParser.parse(pdf_path, raw_text)