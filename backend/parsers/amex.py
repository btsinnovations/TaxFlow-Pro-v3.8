...
def _parse_lines(text: str) -> List[Dict[str, Any]]:
    """American Express layout: MM/DD Description Debit Credit [Balance]."""
...
class AmexParser:
    ...
    def can_handle(cls, text: str) -> bool:
        tl = text.lower()
        return "american express" in tl or "amex" in tl
...
def parse_amex_pdf(pdf_path: str, raw_text: str) -> Dict[str, Any]:
    return AmexParser.parse(pdf_path, raw_text)
