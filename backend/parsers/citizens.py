...
def _parse_lines(text: str) -> List[Dict[str, Any]]:
    """Citizens Bank layout: MM/DD Description Debit Credit [Balance]."""
...
class CitizensBankParser:
    institution_name = "Citizens Bank"

    @classmethod
    def can_handle(cls, text: str) -> bool:
        tl = text.lower()
        return "citizens bank" in tl or "citizens" in tl
...
def parse_citizens_pdf(pdf_path: str, raw_text: str) -> Dict[str, Any]:
    return CitizensBankParser.parse(pdf_path, raw_text)
