...
def _parse_lines(text: str) -> List[Dict[str, Any]]:
    """PNC Bank layout: MM/DD Description Debit Credit [Balance]."""
...
class PNCBankParser:
    ...
    def can_handle(cls, text: str) -> bool:
        tl = text.lower()
        return "pnc bank" in tl or "pncbank" in tl or "pnc" in tl
...
def parse_pnc_pdf(pdf_path: str, raw_text: str) -> Dict[str, Any]:
    return PNCBankParser.parse(pdf_path, raw_text)
