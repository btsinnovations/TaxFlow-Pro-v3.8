...
def _parse_lines(text: str) -> List[Dict[str, Any]]:
    """SoFi layout: MM/DD Description Debit Credit [Balance]."""
...
def parse_sofi_pdf(pdf_path: str, raw_text: str) -> Dict[str, Any]:
    return SoFiParser.parse(pdf_path, raw_text)
