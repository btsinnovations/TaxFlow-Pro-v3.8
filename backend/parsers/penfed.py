...
def _parse_lines(text: str) -> List[Dict[str, Any]]:
    """PenFed layout: MM/DD Description Debit Credit [Balance]."""
...
class PenFedParser:
    ...
    def can_handle(cls, text: str) -> bool:
        tl = text.lower()
        return "penfed" in tl or "pentagon federal" in tl
...
def parse_penfed_pdf(pdf_path: str, raw_text: str) -> Dict[str, Any]:
    return PenFedParser.parse(pdf_path, raw_text)
