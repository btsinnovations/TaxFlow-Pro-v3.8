"""Alliant Credit Union statement parser."""
...
def _parse_lines(text: str) -> List[Dict[str, Any]]:
    """Alliant Credit Union layout: MM/DD Description Debit Credit [Balance]."""
...
class AlliantParser:
    ...
    def can_handle(cls, text: str) -> bool:
        tl = text.lower()
        return "alliant" in tl or "alliant credit union" in tl
...
def parse_alliant_pdf(pdf_path: str, raw_text: str) -> Dict[str, Any]:
    return AlliantParser.parse(pdf_path, raw_text)
