...
def _parse_lines(text: str) -> List[Dict[str, Any]]:
    """Citibank layout: MM/DD Description Debit Credit [Balance]."""
...
class CitibankParser:
    ...
    def can_handle(cls, text: str) -> bool:
        tl = text.lower()
        return "citibank" in tl or "citi" in tl
...
def parse_citibank_pdf(pdf_path: str, raw_text: str) -> Dict[str, Any]:
    return CitibankParser.parse(pdf_path, raw_text)
