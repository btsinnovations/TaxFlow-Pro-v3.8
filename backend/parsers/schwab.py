"""Charles Schwab Bank statement parser."""
...
def _parse_lines(text: str) -> List[Dict[str, Any]]:
    """Charles Schwab Bank layout: MM/DD Description Debit Credit [Balance]."""
...
class SchwabBankParser:
    institution_name = "Charles Schwab Bank"

    @classmethod
    def can_handle(cls, text: str) -> bool:
        tl = text.lower()
        return "schwab" in tl or "charles schwab" in tl
...
def parse_schwab_pdf(pdf_path: str, raw_text: str) -> Dict[str, Any]:
    return SchwabBankParser.parse(pdf_path, raw_text)
