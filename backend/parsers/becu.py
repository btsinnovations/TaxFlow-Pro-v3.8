...
def _parse_lines(text: str) -> List[Dict[str, Any]]:
    """BECU layout: MM/DD Description Debit Credit [Balance]."""
...
class BECUParser:
    ...
    def can_handle(cls, text: str) -> bool:
        tl = text.lower()
        return "becu" in tl or "boeing employees credit union" in tl
...
def parse_becu_pdf(pdf_path: str, raw_text: str) -> Dict[str, Any]:
    return BECUParser.parse(pdf_path, raw_text)
