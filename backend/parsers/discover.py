"""Discover Bank statement parser."""
...
def _parse_lines(text: str) -> List[Dict[str, Any]]:
    """Discover Bank layout: MM/DD Description Debit Credit [Balance]."""
...
class DiscoverBankParser:
    institution_name = "Discover Bank"

    @classmethod
    def can_handle(cls, text: str) -> bool:
        tl = text.lower()
        return "discover bank" in tl or "discover" in tl
...
def parse_discover_pdf(pdf_path: str, raw_text: str) -> Dict[str, Any]:
    return DiscoverBankParser.parse(pdf_path, raw_text)
