...
def _parse_lines(text: str) -> List[Dict[str, Any]]:
    """Synchrony Bank layout: MM/DD Description Debit Credit [Balance]."""
...
class SynchronyBankParser:
    institution_name = "Synchrony Bank"

    @classmethod
    def can_handle(cls, text: str) -> bool:
        tl = text.lower()
        return "synchrony" in tl or "synchrony bank" in tl
...
def parse_synchrony_pdf(pdf_path: str, raw_text: str) -> Dict[str, Any]:
    return SynchronyBankParser.parse(pdf_path, raw_text)
