...
def _parse_lines(text: str) -> List[Dict[str, Any]]:
    """Truist layout: MM/DD Description Debit Credit [Balance]."""
...
def parse_truist_pdf(pdf_path: str, raw_text: str) -> Dict[str, Any]:
    return TruistParser.parse(pdf_path, raw_text)
