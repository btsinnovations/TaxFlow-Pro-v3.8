...
def _parse_lines(text: str) -> List[Dict[str, Any]]:
    """U.S. Bank layout: MM/DD Description Debit Credit [Balance]."""
...
class USBankParser:
    ...
    def can_handle(cls, text: str) -> bool:
        tl = text.lower()
        return "u.s. bank" in tl or "us bank" in tl or "usbank" in tl
...
def parse_us_bank_pdf(pdf_path: str, raw_text: str) -> Dict[str, Any]:
    return USBankParser.parse(pdf_path, raw_text)
