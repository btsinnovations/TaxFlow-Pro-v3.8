...
def _parse_lines(text: str) -> List[Dict[str, Any]]:
    """USAA layout: MM/DD Description Debit Credit [Balance]."""
...
def parse_usaa_pdf(pdf_path: str, raw_text: str) -> Dict[str, Any]:
    return USAAParser.parse(pdf_path, raw_text)
