...
def _parse_lines(text: str) -> List[Dict[str, Any]]:
    """Huntington Bank layout: MM/DD Description Debit Credit [Balance]."""
...
class HuntingtonBankParser:
    institution_name = "Huntington Bank"

    @classmethod
    def can_handle(cls, text: str) -> bool:
        tl = text.lower()
        return "huntington" in tl or "huntington bank" in tl
...
def parse_huntington_pdf(pdf_path: str, raw_text: str) -> Dict[str, Any]:
    return HuntingtonBankParser.parse(pdf_path, raw_text)
