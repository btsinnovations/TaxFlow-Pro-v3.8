"""Marcus by Goldman Sachs statement parser."""
...
def _parse_lines(text: str) -> List[Dict[str, Any]]:
    """Marcus by Goldman Sachs layout: MM/DD Description Debit Credit [Balance]."""
...
class MarcusParser:
    ...
    def can_handle(cls, text: str) -> bool:
        tl = text.lower()
        return "marcus" in tl or "marcus by goldman sachs" in tl
...
def parse_marcus_pdf(pdf_path: str, raw_text: str) -> Dict[str, Any]:
    return MarcusParser.parse(pdf_path, raw_text)
