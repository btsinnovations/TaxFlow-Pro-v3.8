...
def _parse_lines(text: str) -> List[Dict[str, Any]]:
    """Capital One layout: MM/DD Description Debit Credit [Balance]."""
...
class CapitalOneParser:
    ...
    def can_handle(cls, text: str) -> bool:
        tl = text.lower()
        return "capital one" in tl or "capitalone" in tl
...
def parse_capital_one_pdf(pdf_path: str, raw_text: str) -> Dict[str, Any]:
    return CapitalOneParser.parse(pdf_path, raw_text)
